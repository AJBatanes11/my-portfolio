...
function Navigation() {
    return (
        <nav className="bg-white dark:bg-black md:fixed w-full z-20 top-0 start-0 shadow shadow-zinc-100 dark:shadow-zinc-800">
            <div className="max-w-full flex flex-wrap items-center justify-between mx-auto px-20 p-4">
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                        <li>
                            <a href="#intro" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
                                Home
                            </a>
                        </li>
                        <li>
